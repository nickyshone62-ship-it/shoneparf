...
const ShoneCloudSync = {
  // 1. Pousser un avis client dans le Cloud en temps rel (Accessible par l'Administrateur)
  ...
  // 2. Sauvegarder l'ensemble des avis (ex: lors d'une rponse officielle de l'admin)
  ...
  // 5. Rcuprer et fusionner toutes les donnes du Cloud vers l'appareil Administrateur
  async pullAllData() {
    try {
      // Pull Reviews
